...
import { SiHuggingface } from "react-icons/si"; // Import Hugging Face icon
...
const ChatPage = () => {
  ...
  const [userInfo] = useState({ name: "romani" }); // Removed setUserInfo
            ...
            <div className="empty-chat-container">
              <div className="empty-chat-content">
                ...
                <div className="empty-chat-suggestions">
                  <div className="suggestion-pill" onClick={() => setInput("What is The Current Time?")}>
        ...
        <div className="modal-content">
          ...
          <div className="modal-body help-modal-content">
            <div className="help-section">
              ...
              <div className="feature-section">
                ...
                <div className="feature-details">
                  ...
                  <p>Upload documents (PDF, TXT, DOCX) to provide context for the AI. Use the paperclip icon to attach files.</p>
                </div>
              </div>
              ...
              <div className="feature-section">
                ...
                <div className="feature-details">
                  ...
                  <p>Engage in natural language conversations. The AI leverages uploaded documents for accurate, context-aware responses.</p>
                </div>
              </div>
              ...
              <div className="feature-section">
                ...
                <div className="feature-details">
                  <h5>Agent Modes</h5>
                  <ul>
                    <li><strong>Simple Mode:</strong> Provides direct answers.</li>
                    <li><strong>Agent Mode:</strong> Offers advanced reasoning with detailed, step-by-step explanations of the AI's thought process.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="feature-section">
                ...
                <div className="feature-details">
                  ...
                  <p>Easily create, rename, or delete chats using the intuitive sidebar controls.</p>
                </div>
              </div>
            </div>
            ...
            <div className="about-section mt-4">
              ...
              <p>RAG AI-Agent is a powerful Retrieval-Augmented Generation AI assistant. It seamlessly integrates large language models with document-based knowledge retrieval, enabling rich conversational interactions. Upload your files to have them semantically parsed, indexed, and instantly available for intelligent queries.</p>
              <div className="version-info">
                <h5>Developed by</h5>
                <p>Kiran S Hegde</p>
                <h5>Version</h5>
                <p>v1.0.8</p>
                <p><small>Licensed under <a href="https://github.com/DashMav/AgenticRAG/blob/main/LICENSE" target="_blank" rel="noreferrer">MIT</a></small></p>
              </div>
            </div>
          </div>
              ...
              <div className="developer-section">
                <div className="developer-info">
                  <div className="developer-bio">
                    <p><strong>Kiran S</strong> – CS grad, AI enthusiast</p>
                    <p>Feel free to reach out for collaborations, questions, or new projects!</p>
                    <p>Email: <a href="mailto:kiran.s.hegde.05@gmail.com">kiran.s.hegde.05@gmail.com</a></p>
                  </div>
                  <div className="social-icons-container">
                    <h6 className="social-title">Connect with me</h6>
                    <div className="social-icons">
                      <a href="https://www.linkedin.com/in/kiran-s-hegde/" target="_blank" rel="noreferrer" className="social-link">
                        <BsLinkedin size={24} title="LinkedIn" />
                      </a>
                      <a href="/twitter-error" target="_blank" rel="noreferrer" className="social-link">
                        <BsTwitter size={24} title="Twitter/X" />
                      </a>
                      <a href="https://github.com/DashMav" target="_blank" rel="noreferrer" className="social-link">
                        <BsGithub size={24} title="GitHub" />
                      </a>
                      <a href="https://www.kaggle.com/kiranshegde" target="_blank" rel="noreferrer" className="social-link">
                        <SiKaggle size={24} title="Kaggle" />
                      </a>
                      <a href="https://huggingface.co/DashMav" target="_blank" rel="noreferrer" className="social-link">
                        <SiHuggingface size={24} title="Hugging Face" />
                      </a>
                    </div>
                  </div>
                </div>
